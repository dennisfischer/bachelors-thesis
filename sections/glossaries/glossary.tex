...
{
  name={WPM},
  description={\syscall{WriteProcessMemory} is an exported function of the Windows API. This function allows memory modification of another process. A process handle with \syscall{PROCESS\_VM\_WRITE} permissions is required to use this function},
